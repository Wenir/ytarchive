...
class TestCrypt:
    ...
    @pytest.fixture
    def crypt(self, test_key, test_iv):
    ...
    def test_encrypt_same_result_different_chunk_sizes(self, crypt):
    ...
    def test_encrypt_decrypt_multiple_chunks(self, crypt):
    ...
    def test_encrypt_decrypt_empty_data(self, crypt):
        original_data = b""
    ...
    def test_encrypt_decrypt_large_data(self, crypt):
    ...
    def test_encrypt_output_different_from_input(self, crypt):
    ...
    def test_same_input_produces_same_output(self, crypt):
    ...
    def test_different_keys_produce_different_outputs(self, test_iv):
    ...
    def test_different_ivs_produce_different_outputs(self, test_key):
    ...
    def test_encrypt_non_bytes_raises_assertion_error(self, crypt):
        with pytest.raises(AssertionError):
            list(crypt.encrypt(["not bytes"]))

    def test_decrypt_non_bytes_raises_assertion_error(self, crypt):
        with pytest.raises(AssertionError):
            list(crypt.decrypt(["not bytes"]))

    def test_partial_decryption_chunks(self, crypt):
    ...
    def test_generator_behavior(self, crypt):
